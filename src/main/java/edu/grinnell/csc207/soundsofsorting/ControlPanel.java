...
public class ControlPanel extends JPanel {
    ...
    /**
     * Generates a list of sorting events by sorting the given array using the specified sorting algorithm.
     ...
     * @param notes the NoteIndices object that this control panel manages
